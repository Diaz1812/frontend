// app/admin/microdata-option/new/page.tsx
"use client";
...
export default function MicrodataOptionCreatePage() {
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl font-bold text-white">Add New Microdata Option</h1>
        </div>
        <button
